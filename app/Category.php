...
//MUTATOR Metode yang digunakan untuk membaca nilai variabel pada suatu class, baik berupa instance maupun static.
public function setSlugAttribute($value)
{
    $this->attributes['slug'] = Str::slug($value);
}

//ACCESSOR Method yang digunakan untuk akses objek lain agar bisa mengubah data.
